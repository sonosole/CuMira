import Mira.DNN_Batch_TCS_With_Softmax
import Mira.RNN_Batch_TCS_With_Softmax
import Mira.CRNN_Batch_TCS_With_Softmax


"""
    DNN_Batch_TCS_With_Softmax(x::Variable{CuArray{T}},
                               seqlabels::Vector,
                               inputlens;
                               background::Int=1,
                               foreground::Int=2,
...
# Structure
    ...
    └───┘         └─┬─┘          └─┬─┘       │
                  ...
                  └───┘                    └───┘
"""
function DNN_Batch_TCS_With_Softmax(x::Variable{CuArray{T}},
                                    seqlabels::Vector,
                                    inputlens;
                                    background::Int=1,
                                    foreground::Int=2,
...
"""
    RNN_Batch_TCS_With_Softmax(x::Variable{CuArray{T}},
                               seqlabels::Vector,
                               inputlens;
                               background::Int=1,
                               foreground::Int=2,
...
# Structure
    ...
    └───┘         └─┬─┘          └─┬─┘       │
                  ...
                  └───┘                    └───┘
"""
function RNN_Batch_TCS_With_Softmax(x::Variable{CuArray{T}},
                                    seqlabels::Vector,
                                    inputlens;
                                    background::Int=1,
                                    foreground::Int=2,
...
"""
    CRNN_Batch_TCS_With_Softmax(x::Variable{CuArray{T}},
                                seqlabels::Vector;
                                background::Int=1,
                                foreground::Int=2,
                                weight=1.0) where T
...
# Structure
    ...
    └───┘         └─┬─┘          └─┬─┘       │
                  ...
                  └───┘                    └───┘
"""
function CRNN_Batch_TCS_With_Softmax(x::Variable{CuArray{T}},
                                     seqlabels::Vector;
                                     background::Int=1,
                                     foreground::Int=2,
