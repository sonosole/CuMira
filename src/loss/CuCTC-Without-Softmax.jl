import Mira.DNN_CTC
import Mira.DNN_Batch_CTC
import Mira.RNN_Batch_CTC
import Mira.CRNN_Batch_CTC


"""
    DNN_CTC(p::Variable{CuArray{T}}, seq; blank=1, weight=1.0)
...
# Structure
    ...
    └───┘                                    └───┘
"""
function DNN_CTC(p::Variable{CuArray{T}}, seq; blank=1, weight=1.0) where T
    L = length(seq) * 2 + 1
...
"""
    DNN_Batch_CTC(p::Variable{CuArray{T}}, seqlabels::Vector, inputlens; blank=1, weight=1.0) where T
...
# Structure
    ...
    └───┘                                    └───┘
"""
function DNN_Batch_CTC(p::Variable{CuArray{T}}, seqlabels::Vector, inputlens; blank=1, weight=1.0) where T
...
"""
    RNN_Batch_CTC(p::Variable{CuArray{T}}, seqlabels::Vector, inputlens; blank=1, weight=1.0) where T
...
# Structure
    ...
    └───┘                                    └───┘
"""
function RNN_Batch_CTC(p::Variable{CuArray{T}}, seqlabels::Vector, inputlens; blank=1, weight=1.0) where T
...
"""
    CRNN_Batch_CTC(p::Variable{CuArray{T}}, seqlabels::Vector) where T -> LogLikely
...
# Structure
    ...
    └───┘                                    └───┘
"""
function CRNN_Batch_CTC(p::Variable{CuArray{T}}, seqlabels::Vector; blank=1, weight=1.0) where T
